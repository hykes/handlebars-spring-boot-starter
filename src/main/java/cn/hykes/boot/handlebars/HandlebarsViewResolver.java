 ...
 */
package cn.hykes.boot.handlebars;

import cn.hykes.boot.helpers.AbstractHelpers;
...
public class HandlebarsViewResolver extends AbstractTemplateViewResolver
  ...
  public void afterPropertiesSet() {
     ...
     * 新增注册自定义helpers
     */
    Map<String, AbstractHelpers> helpersMap = getApplicationContext().getBeansOfType(AbstractHelpers.class);
    for (AbstractHelpers abstractHelpers : helpersMap.values()) {
      Map<String, Helper<?>> helpers= abstractHelpers.getHelpers();
